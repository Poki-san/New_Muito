                                ...
                                <View style={{width:width, height:'100%', borderBottomLeftRadius:16, borderBottomRightRadius:16, position:"absolute", justifyContent:"space-between", top:0, zIndex:999, pointerEvents:'box-none'}}>
                                            ...
                                            <View style={{flexDirection:'row', width:"100%", justifyContent:"space-between", alignItems:'center'}}>
                                                <View style={{flexDirection:"row", alignItems:"center", gap:8, marginLeft:16}}>
                                                    <TouchableOpacity activeOpacity={0.7} onPress={goBack}>
                                                        <BlurView intensity={50} tint='systemChromeMaterialDark' experimentalBlurMethod='dimezisBlurView' style={{borderRadius:16,backgroundColor:'#00000070', overflow:'hidden', width:42, height:42, alignItems:"center", justifyContent:"center"}}>
                                                            <BackArrowIcon/>
                                                        </BlurView>
                                                    </TouchableOpacity>
                                                ...
                                                {alert && <View style={{padding:8, right:16, top:53, overflow:"hidden", borderRadius:16, backgroundColor:'#00000088', gap:7, position:'absolute'}}>
                                    ...
                                    <Animated.View style={{maxHeight:more ? HeightAnimTwo : HeightAnim, borderBottomRightRadius:16, borderBottomLeftRadius:16, overflow:'hidden'}}>
                                        <GestureRecognizer onSwipeDown={()=>{
                                            ...
                                            <BlurView style={{width:"100%", borderWidth:1, borderColor:'#B5B5B588', paddingHorizontal:16, paddingBottom:16, borderRadius:16, overflow:'hidden'}} tint='systemChromeMaterialDark' intensity={40} experimentalBlurMethod='dimezisBlurView'>
