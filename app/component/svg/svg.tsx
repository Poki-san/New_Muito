...
export function TGIcon({color='#fff'}) {
  return (
    <Svg
      width={24}
      height={24}
...
export function InstaEventIcon({color="#fff", opacity=0.8}) {
  return (
    <Svg
      width={32}
      height={33}
    ...
    >
      ...
      <Defs>
        <ClipPath id="clip0_28407_4242">
          <Path fill={color} transform="translate(4 3.5)" d="M0 0H24V24H0z" />
        </ClipPath>
      </Defs>
    </Svg>
  )
...
export function GOIcon({go=false}) {
  return (
    <Svg
      width={24}
      height={24}
    ...
    >
      <Path
        d="M10.488 10.52v7.104c0 1.813-.448 3.21-1.344 4.192-.896.96-2.197 1.44-3.904 1.44-1.707 0-3.008-.48-3.904-1.44-.896-.981-1.344-2.379-1.344-4.192V5.976c0-1.813.448-3.2 1.344-4.16C2.232.835 3.533.344 5.24.344c1.707 0 3.008.49 3.904 1.472.896.96 1.344 2.347 1.344 4.16v2.176H7.16v-2.4c0-1.472-.608-2.208-1.824-2.208-1.216 0-1.824.736-1.824 2.208v12.096c0 1.45.608 2.176 1.824 2.176 1.216 0 1.824-.725 1.824-2.176V13.72h-1.6v-3.2h4.928zm1.973-4.544c0-1.792.458-3.179 1.376-4.16.917-.981 2.24-1.472 3.968-1.472 1.728 0 3.05.49 3.968 1.472.917.981 1.376 2.368 1.376 4.16v11.648c0 1.792-.459 3.179-1.376 4.16-.918.981-2.24 1.472-3.968 1.472-1.728 0-3.05-.49-3.968-1.472-.918-.981-1.376-2.368-1.376-4.16V5.976zm3.52 11.872c0 1.472.608 2.208 1.824 2.208 1.216 0 1.824-.736 1.824-2.208V5.752c0-1.472-.608-2.208-1.824-2.208-1.216 0-1.824.736-1.824 2.208v12.096z"
        fill="#171717"
        fillOpacity={go?0.5:1}
      />
    </Svg>
  )
}
...
export function QRIcon(props) {
  return (
    <Svg
      ...
      {...props}
    >
      <G clipPath="url(#clip0_28350_3346)">
        <Path
          d="M.703 4.552V.703h3.849m18.745 3.849V.703h-3.38M4.552 23.297H.703v-3.849m18.745 3.849h3.849v-3.849M3.516 13.453V12h9.793m7.175-2.825V12h-4.362M4.674 9.187H3.516m3.97 0H12V3.516m-2.813 0v2.859M6.376 12v1.453M12 18.61v1.875h-1.453M12 12v3.797h-1.453m-1.36-6.61V12m0-7.055H12M17.655 12v2.825M3.515 3.515h2.813v2.813H3.516V3.516zm0 12.75h4.22v4.22h-4.22v-4.22zm11.31-1.44h5.66v5.66h-5.66v-5.66zm0-11.31h5.66v5.66h-5.66v-5.66z"
          stroke="#171717"
          strokeWidth={1.5}
          strokeMiterlimit={10}
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <Circle cx={17.6719} cy={17.7188} r={0.703125} fill="#171717" />
        <Circle cx={17.6719} cy={6.32812} r={0.703125} fill="#171717" />
      </G>
      <Defs>
        <ClipPath id="clip0_28350_3346">
...
export function LogoIcon(props) {
  return (
    ...
    >
      <Path
        d="M.54 50l.84-48.6h9.18l6.9 33.66 7.2-33.66h8.88l.9 48.6h-6.6l-.72-33.78L20.22 50h-5.34L7.86 16.1 7.2 50H.54zm54.397.66c-3.6 0-6.4-.66-8.4-1.98-2-1.32-3.38-3.2-4.14-5.64-.76-2.44-1.14-5.36-1.14-8.76V1.4h8.64v33.9c0 1.52.1 2.96.3 4.32.2 1.32.66 2.4 1.38 3.24.76.8 1.88 1.2 3.36 1.2 1.56 0 2.68-.4 3.36-1.2.72-.84 1.18-1.92 1.38-3.24.24-1.36.36-2.8.36-4.32V1.4h8.58v32.88c0 3.4-.38 6.32-1.14 8.76-.76 2.44-2.14 4.32-4.14 5.64-1.96 1.32-4.76 1.98-8.4 1.98zM75.841 50V1.4h8.76V50h-8.76zm21.144 0V7.94h-7.74V1.4h24.24v6.54h-7.62V50h-8.88zm33.887.66c-3.44 0-6.18-.64-8.22-1.92-2.04-1.28-3.5-3.12-4.38-5.52-.88-2.4-1.32-5.24-1.32-8.52V16.52c0-3.28.44-6.08 1.32-8.4.88-2.36 2.34-4.16 4.38-5.4 2.04-1.24 4.78-1.86 8.22-1.86 3.52 0 6.28.62 8.28 1.86 2.04 1.24 3.5 3.04 4.38 5.4.92 2.32 1.38 5.12 1.38 8.4v18.24c0 3.24-.46 6.06-1.38 8.46-.88 2.36-2.34 4.2-4.38 5.52-2 1.28-4.76 1.92-8.28 1.92zm0-6.54c1.48 0 2.56-.32 3.24-.96.72-.64 1.2-1.52 1.44-2.64s.36-2.34.36-3.66V14.48c0-1.36-.12-2.58-.36-3.66s-.72-1.92-1.44-2.52c-.68-.64-1.76-.96-3.24-.96-1.4 0-2.46.32-3.18.96-.72.6-1.2 1.44-1.44 2.52s-.36 2.3-.36 3.66v22.38c0 1.32.1 2.54.3 3.66.24 1.12.72 2 1.44 2.64.72.64 1.8.96 3.24.96z"
        fill="#83FDF4"
      />
    </Svg>
  )
...
export function EyeClose(props) {
  return (
    ...
    >
      <Path
        d="M7.103 11.46a.556.556 0 01-.398-.165A3.229 3.229 0 015.753 9 3.249 3.249 0 019 5.753c.863 0 1.68.337 2.295.952a.562.562 0 010 .795L7.5 11.295a.556.556 0 01-.397.165zM9 6.877a2.125 2.125 0 00-1.845 3.173l2.895-2.895A2.112 2.112 0 009 6.878z"
        fill="#6D6D6D"
      />
      <Path
        d="M4.2 13.883a.571.571 0 01-.368-.135 10.886 10.886 0 01-2.137-2.498c-.795-1.238-.795-3.255 0-4.5C3.525 3.885 6.187 2.235 9 2.235c1.65 0 3.277.57 4.703 1.642a.563.563 0 01-.675.9C11.797 3.847 10.402 3.36 9 3.36c-2.423 0-4.74 1.455-6.36 3.997-.563.878-.563 2.408 0 3.285a10.297 10.297 0 001.92 2.25.567.567 0 01.06.796.545.545 0 01-.42.194zM9 15.765a7.406 7.406 0 01-2.91-.6.562.562 0 01.435-1.035c.795.337 1.627.51 2.467.51 2.423 0 4.74-1.455 6.36-3.998.563-.877.563-2.407 0-3.284-.232-.368-.487-.72-.757-1.05a.57.57 0 01.082-.795.563.563 0 01.796.082c.292.36.577.75.832 1.155.795 1.237.795 3.255 0 4.5-1.83 2.865-4.492 4.515-7.305 4.515z"
        fill="#6D6D6D"
      />
      <Path
        d="M9.518 12.203a.568.568 0 01-.556-.458.552.552 0 01.45-.652 2.115 2.115 0 001.665-1.665.569.569 0 01.66-.45c.308.06.51.352.45.66a3.223 3.223 0 01-2.564 2.565c-.038-.008-.068 0-.105 0zM1.5 17.063a.556.556 0 01-.397-.165.566.566 0 010-.796L6.705 10.5a.566.566 0 01.795 0 .566.566 0 010 .795l-5.603 5.603a.556.556 0 01-.397.165zM10.898 7.665A.556.556 0 0110.5 7.5a.566.566 0 010-.795l5.602-5.603a.566.566 0 01.796 0 .566.566 0 010 .795L11.295 7.5a.556.556 0 01-.397.165z"
        fill="#6D6D6D"
      />
    </Svg>
  )
...
export function EyeOpen(props) {
  return (
    ...
    >
      <Path
        d="M9 12.248A3.249 3.249 0 015.753 9 3.249 3.249 0 019 5.753 3.249 3.249 0 0112.248 9 3.249 3.249 0 019 12.248zm0-5.37c-1.17 0-2.122.952-2.122 2.122S7.83 11.123 9 11.123 11.123 10.17 11.123 9c0-1.17-.953-2.122-2.123-2.122z"
        fill="#6D6D6D"
      />
      <Path
        d="M9 15.765c-2.82 0-5.482-1.65-7.313-4.515-.795-1.238-.795-3.255 0-4.5C3.526 3.885 6.188 2.235 9 2.235c2.813 0 5.475 1.65 7.305 4.515.795 1.237.795 3.255 0 4.5-1.83 2.865-4.492 4.515-7.305 4.515zM9 3.36c-2.423 0-4.74 1.455-6.36 3.997-.563.878-.563 2.408 0 3.285C4.26 13.186 6.577 14.64 9 14.64c2.422 0 4.74-1.455 6.36-3.998.563-.877.563-2.407 0-3.285C13.74 4.815 11.422 3.36 9 3.36z"
        fill="#6D6D6D"
      />
    </Svg>
  )
  ...
  return (
    ...
    >
      <Rect
        ...
        height={46}
        rx={16}
        fill="url(#paint0_linear_28236_174)"
      />
      <Path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M13.826 34.21l4.49-1.178.433.258a11.844 11.844 0 006.037 1.653h.005c6.538 0 11.859-5.321 11.862-11.862a11.79 11.79 0 00-3.471-8.391 11.78 11.78 0 00-8.386-3.48c-6.543 0-11.864 5.322-11.867 11.862 0 2.24.626 4.424 1.814 6.312l.282.449-1.199 4.377zm17.666-8.055c.25.12.417.2.489.32.089.15.089.863-.208 1.696s-1.722 1.594-2.407 1.696c-.614.092-1.392.13-2.246-.142a20.476 20.476 0 01-2.033-.75c-3.343-1.444-5.602-4.684-6.029-5.297a4.637 4.637 0 00-.062-.088l-.003-.004c-.189-.252-1.453-1.939-1.453-3.685 0-1.642.806-2.503 1.178-2.9l.07-.075a1.31 1.31 0 01.95-.446c.238 0 .476.003.684.013h.08c.208 0 .467-.002.722.612.099.236.242.587.394.956.307.747.646 1.572.706 1.692.089.178.148.386.03.625l-.05.101c-.09.182-.156.316-.307.493-.06.07-.121.145-.183.22-.123.15-.245.299-.352.405-.179.178-.364.37-.157.728.209.357.924 1.524 1.984 2.47a9.208 9.208 0 002.632 1.664c.098.042.178.077.236.106.356.178.564.148.772-.09.208-.237.892-1.04 1.13-1.398.237-.356.475-.297.802-.178.327.12 2.08.982 2.436 1.16l.195.096z"
        fill="#181818"
      />
      <Defs>
        <LinearGradient
          id="paint0_linear_28236_174"
          x1={24.5}
          y1={0}
          x2={24.5}
          y2={46}
        ...
        >
          <Stop stopColor="#83FDF4" />
          <Stop offset={1} stopColor="#85FDFB" />
        </LinearGradient>
      </Defs>
    </Svg>
  )
  ...
  return (
    ...
    >
      <Rect
        ...
        height={46}
        rx={16}
        fill="url(#paint0_linear_28236_172)"
      />
      <Path
        d="M11.363 22.303c2.455-1.36 5.195-2.497 7.756-3.638 4.406-1.87 8.829-3.707 13.297-5.418.869-.291 2.43-.576 2.584.72-.084 1.835-.429 3.659-.666 5.483-.6 4.01-1.294 8.008-1.971 12.006-.233 1.332-1.891 2.021-2.952 1.169-2.55-1.733-5.119-3.449-7.636-5.222-.824-.843-.06-2.053.677-2.655 2.1-2.082 4.326-3.851 6.317-6.041.536-1.304-1.05-.205-1.573.132-2.875 1.993-5.679 4.108-8.71 5.86-1.548.857-3.352.124-4.9-.354-1.387-.578-3.42-1.16-2.224-2.042z"
        fill="#181818"
      />
      <Defs>
        <LinearGradient
          id="paint0_linear_28236_172"
          x1={24.5}
          y1={0}
          x2={24.5}
          y2={46}
